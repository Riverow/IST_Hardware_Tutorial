...
public class HardDisk_Script : MonoBehaviour {
	...
	void OnCollisionEnter (Collision col)
	{
		...
		if (col.transform.tag == "HardDisk") 
		{
			...
			GameObject.Find ("GameManager").GetComponent<ObjectiveManager> ().HardDriveInstalled = true;
